...
function updateSbIndicator(state) {
  ...
  const map = {
    ...
    disconnected: { cls:'checking',     text:'Modo offline (demo)' },
  };
      ...
      <div>
        ...
        <div class="da-list">
          ...
          <div class="da da-info">
            ...
            <button class="da-add" onclick="addFromDd('${dim}','${area}','${DIM_RECS[dim]?.substring(0,55).replace(/'/g,\`'\`) || dim}')">+ Adicionar ao plano</button>
          </div>
        </div>
      </div>
      <div>
